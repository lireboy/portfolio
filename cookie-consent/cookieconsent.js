...
! function() {
    ...
    'undefined' != typeof window && 'function' != typeof window[n] && (window[n] = function(n) {
        var t, e, o, i, r, c, a, u, f, d, v, s, l, b, p, m, y, w, g, h, _, k, x, O, j, S, T, J, N, D, C, I, E = { mode: 'opt-in', current_lang: 'en', auto_language: null, autorun: !0, page_scripts: !0, hide_from_bots: !0, cookie_name: 'cc_cookie', cookie_expiration: 182, cookie_domain: window.location.hostname, cookie_path: '/', cookie_same_site: 'Lax', use_rfc_cookie: !1, autoclear_cookies: !0, revision: 0, script_selector: 'data-cookiecategory' },
            ...
            on = function(n) {
                for (var t = 'accept-', e = a('c-settings'), o = a(t + 'all'), i = a(t + 'necessary'), r = a(t + 'custom'), c = 0; c < e.length; c++) e[c].setAttribute('aria-haspopup', 'dialog'), gn(e[c], 'click', (function(n) { n.preventDefault(), U.showSettings(0) }));
                for (c = 0; c < o.length; c++) gn(o[c], 'click', (function(n) { u(n, 'all') }));
                for (c = 0; c < r.length; c++) gn(r[c], 'click', (function(n) { u(n) }));
                for (c = 0; c < i.length; c++) gn(i[c], 'click', (function(n) { u(n, []) }));
            ...
            an = function(n) {
                ...
                for (var v = 0; v < d; ++v) {
                    ...
                    if (k.className = 'title', g.className = 'c-bl', h.className = 'desc', void 0 !== b) {
                        ...
                        var F = b.value;
                        L.value = F, P.textContent = s, R.insertAdjacentHTML('beforeend', s), k.appendChild(R), M.appendChild(q), M.appendChild(B), A ? b.enabled ? (L.checked = !0, !J && Z.push(!0), b.enabled && !J && V.push(F)) : !J && Z.push(!1) : fn(z.categories, F) > -1 ? (L.checked = !0, !J && Z.push(!0)) : !J && Z.push(!1), !J && $.push(F), b.readonly ? (L.disabled = !0, _n(M, 'c-ro'), !J && nn.push(!0)) : !J && nn.push(!1), _n(h, 'b-acc'), _n(k, 'b-bn'), _n(g, 'b-ex'), h.id = E, h.setAttribute('aria-hidden', 'true'), G.appendChild(L), G.appendChild(M), G.appendChild(P), k.appendChild(G), w && function(n, t, e) { gn(R, 'click', (function() { xn(t, 'act') ? (kn(t, 'act'), e.setAttribute('aria-expanded', 'false'), n.setAttribute('aria-hidden', 'true')) : (_n(t, 'act'), e.setAttribute('aria-expanded', 'true'), n.setAttribute('aria-hidden', 'false')) }), !1) }(h, g, R)
                    } else if (s) {
                        var H = dn('div');
                ...
                N || ((N = dn('div')).id = 's-bns'), C || ((C = dn('button')).id = 's-all-bn', C.className = 'c-bn', N.appendChild(C), gn(C, 'click', (function() { U.hideSettings(), U.hide(), U.accept('all') }))), C.innerHTML = t.languages[n].settings_modal.accept_all_btn;
                var ln = t.languages[n].settings_modal.reject_all_btn;
                if (ln && (I || ((I = dn('button')).id = 's-rall-bn', I.className = 'c-bn', gn(I, 'click', (function() { U.hideSettings(), U.hide(), U.accept([]) })), O.className = 'bns-t', N.appendChild(I)), I.innerHTML = ln), D || ((D = dn('button')).id = 's-sv-bn', D.className = 'c-bn', N.appendChild(D), gn(D, 'click', (function() { U.hideSettings(), U.hide(), U.accept() }))), D.innerHTML = t.languages[n].settings_modal.save_settings_btn, J) return O.replaceChild(J, T), void(T = J);
        ...
        U.updateLanguage = function(n, e) { if ('string' == typeof n) { var o = rn(n, t.languages); return (o !== E.current_lang || !0 === e) && (E.current_lang = o, G && (cn(o), on(k)), an(o), !0) } };
        var un = function(n) {
                var t = a.length,
                    e = -1;
                H = !1;
            ...
            if (!document.getElementById('cc_div')) {
                ...
                if ((e = z.consent_date) && (e = new Date(e)), (o = z.last_consent_update) && (o = new Date(o)), R = void 0 !== z.data ? z.data : null, q && z.revision !== E.revision && (B = !1), G = A = !(c && B && e && o && i), function() {
                        ...
                        function t(t, e) {
                            var o = !1,
                                i = !1;
                            try { for (var r, c = t.querySelectorAll(n.join(':not([tabindex="-1"]), ')), a = c.length, u = 0; u < a;) r = c[u].getAttribute('data-focus'), i || '1' !== r ? '0' === r && (o = c[u], i || '0' === c[u + 1].getAttribute('data-focus') || (i = c[u + 1])) : i = c[u], u++ } catch (e) { return t.querySelectorAll(n.join(', ')) }
                    ...
                    }(t.gui_options), on(), E.autorun && G && U.show(t.delay || 0), setTimeout((function() { _n(b, 'c--anim') }), 30), setTimeout((function() {
                        var n, t;
        ...
        }, U.showSettings = function(n) { setTimeout((function() { _n(tn, 'show--settings'), x.setAttribute('aria-hidden', 'false'), M = !0, setTimeout((function() { L ? l = document.activeElement : s = document.activeElement, 0 !== Y.length && (Y[3] ? Y[3].focus() : Y[0].focus(), r = Y) }), 200) }), n > 0 ? n : 0) };
        var ln = function(n) {
            if (E.page_scripts) {
                        ...
                        if (t < n.length) {
                            ...
                            if (fn(e, r) > -1) {
                                ...
                                if (a.textContent = i.innerHTML, function(n, t) {
                                    ...
                                    }(a, i), c ? a.src = c : c = i.src, c && (a.readyState ? a.onreadystatechange = function() { 'loaded' !== a.readyState && 'complete' !== a.readyState || (a.onreadystatechange = null, o(n, ++t)) } : a.onload = function() { a.onload = null, o(n, ++t) }), i.parentNode.replaceChild(a, i), c) return
                            }
                            o(n, ++t)
                        }
                    };
        ...
        }, U.get = function(n, t) { return JSON.parse(yn(t || E.cookie_name, 'one', !0) || '{}')[n] }, U.getConfig = function(n) { return E[n] || t[n] };
        var bn = function() { return K = z.categories || [], Q = $.filter((function(n) { return -1 === fn(K, n) })), { accepted: K, rejected: Q } },
            pn = function(n) {
                var t = 'custom',
                    e = nn.filter((function(n) { return !0 === n })).length;
                return n.accepted.length === $.length ? t = 'all' : n.accepted.length === e && (t = 'necessary'), t
            };
        U.getUserPreferences = function() { var n = bn(); return { accept_type: pn(n), accepted_categories: n.accepted, rejected_categories: n.rejected } }, U.loadScript = function(n, t, e) {
            ...
            else a = function() { for (var n = document.querySelectorAll('.c-tgl') || [], t = [], e = 0; e < n.length; e++) n[e].checked && t.push(n[e].value); return t }();
            if (c.length >= 1)
                for (s = 0; s < c.length; s++) a = a.filter((function(n) { return n !== c[s] }));
            ...
            yn = function(n, t, e) {
                ...
                if ('one' === t) {
                    if ((o = (o = document.cookie.match('(^|;)\\s*' + n + '\\s*=\\s*([^;]+)')) ? e ? o.pop() : n : '') && n === E.cookie_name) {
                        try { o = JSON.parse(o) } catch (n) { try { o = JSON.parse(decodeURIComponent(o)) } catch (n) { o = {} } }
                        o = JSON.stringify(o)
                    }
                } else if ('all' === t) {
        ...
        U.validCookie = function(n) { return '' !== yn(n, 'one', !0) };
        var gn = function(n, t, e, o) { n.addEventListener(t, e, !0 === o && { passive: !0 }) },
            ...
            xn = function(n, t) { return n.classList.contains(t) };
        return U
    })
}();