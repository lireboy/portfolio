          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Timur`} <span className="txt-rotate" dataPeriod="500" data-rotate='[ "Web Developer", "Software Developer", "Lead Developer" ]'><span className="wrap">{text}</span></span></h1>
